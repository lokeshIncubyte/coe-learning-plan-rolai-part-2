...
status: skip
source: "srv-009 spec — GenerateController.generate() uses ChoiceGeneratorService instead of hardcoded choices"
covers: happy-path
---
