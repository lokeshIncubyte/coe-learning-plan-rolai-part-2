...
## RED
- **Test file**: `app/narrative/__tests__/useStream.test.tsx` (append to the file — do NOT recreate it; the imports and `beforeEach` from cycle-039 are already present). The file will contain 2 `describe` blocks after this append.
- **Assertion**:
  ```tsx
