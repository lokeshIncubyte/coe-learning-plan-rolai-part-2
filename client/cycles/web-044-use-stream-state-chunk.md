...
## RED
- **Test file**: `app/narrative/__tests__/useStreamState.test.tsx` (append a new `describe` block — do NOT recreate the file; imports from web-043 are already present)
- **Assertion**:
  ```tsx
